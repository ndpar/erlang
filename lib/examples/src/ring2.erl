...
%% @doc Ring benchmark.
%%
%% This version implements functional algorithm:
%% fold over sequence of natural numbers `1..N'
%% to build a circular linked list of processes.
%% The shell process is not a part of the ring.
%%
...
%%
%% @reference [A2] Exercise 12.3, p. 198.
%% @see ring
%%
-module(ring2).
...
%%
%% @doc Creates N processes in a ring.
